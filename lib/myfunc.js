...
exports.smsg = (TaycInc, m, store) => {
    ...
    if (m.message) {
        ...
        m.body = m.message.conversation || m.msg.caption || m.msg.text || (m.mtype == 'listResponseMessage') && m.msg.singleSelectReply.selectedRowId || ["contactMessage", "contactsArrayMessage"].includes(m.mtype) && "contact message" || (m.mtype == 'buttonsResponseMessage') && m.msg.selectedButtonId || (m.mtype == 'viewOnceMessage') && m.msg.caption || m.text
        ...
        if (m.quoted) {
            ...
            m.quoted.fromMe = m.quoted.sender === (TaycInc.user && TaycInc.user.id)
            m.quoted.text = m.quoted.text || m.quoted.caption || m.quoted.conversation || m.quoted.contentText || m.quoted.selectedDisplayText || m.quoted.title || ''
            m.quoted.mentionedJid = m.msg.contextInfo ? m.msg.contextInfo.mentionedJid : []
            m.getQuotedObj = m.getQuotedMessage = async () => {
                if (!m.quoted.id) return false
                let q = await store.loadMessage(m.chat, m.quoted.id, TaycInc)
             ...
             * @returns 
             */
            m.quoted.delete = () => TaycInc.sendMessage(m.quoted.chat, {
                delete: vM.key
            })
     ...
     */
    m.reply = (text, chatId = m.chat, options = {}) => Buffer.isBuffer(text) ? TaycInc.sendMedia(chatId, text, 'file', '', m, {
        ...options
    }) : TaycInc.sendText(chatId, text, m, {
        ...options
    })
    /**
     * Copy this message
     ...
     * @returns 
     */
    m.copyNForward = (jid = m.chat, forceForward = false, options = {}) => TaycInc.copyNForward(jid, m, forceForward, options)
...
exports.isAdmin = async (sock, chatId, senderId) => {
    try {
