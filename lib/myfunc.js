    ...
    if (m.message) {
        ...
        m.body =
            m.message.conversation ||
                ...
                (["contactMessage", "contactsArrayMessage"].includes(m.mtype) ? "contact message" : null) ||
                (m.mtype === 'buttonsResponseMessage' ? m.msg.selectedButtonId : null) ||
                (m.mtype === 'viewOnceMessage' ? m.msg.caption : "N/A") ||
                ['imageMessage', 'videoMessage', 'audioMessage', 'stickerMessage', 'documentMessage'].includes(m.mtype) ? "media message" : null ||
                (m.mtype === "protocolMessage" ? "N/A" : null) ||
            m.text;
